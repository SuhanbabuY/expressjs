...
app.get('/student/:id', (req, res) => {
    ...
    res.render('student/show', { 
        title: 'Show Student',
        message: `Show student details for student with ID: ${studentId}`,
        studentId: studentId
    });
});
app.get('/student/:id/edit', (req, res) => {
    ...
    res.render('student/edit', {
        title: 'Edit Student',
        message: `Edit student details for student with ID: ${studentId}`,
        studentId: studentId,
        studentName: 'Suhanbabu',
        studentAge: 25
    });
});
...
app.put('/student/:id', (req, res) => {
    ...
    const { name, age } = req.body;
    res.send(`update student details for student with ID: ${studentId}, New Name: ${name}, New Age: ${age}`);
});// update student details
...
app.listen(port, () => {
    console.log(`suhanbabu's app listening on port ${port}`);
});